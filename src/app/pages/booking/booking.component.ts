...
export class BookingComponent implements OnInit, OnDestroy {
    readonly possibleTimeOptions: Array<string> = [
        '8:00',
        '9:00',
        '10:00',
        '11:00',
    ...
    ngOnInit() {
        ...
        this.bookingForm
            .get('UID')
            ?.setValue(this.userService.getSignedInUserId())
    ...
    onDateChange() {
        ...
        this.bookingForm
            .get('date')
            ?.setValue(this.datePipe.transform(this.selectedDate))
        console.log('selected date: ', this.selectedDate)

        this.subscription = this.bookingService
            .getBookingByDate(this.bookingForm.get('date')?.value as string)
            .subscribe((bookings) => {
